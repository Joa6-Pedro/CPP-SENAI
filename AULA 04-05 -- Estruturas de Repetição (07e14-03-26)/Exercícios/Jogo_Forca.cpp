/*
 Requisição - Faça um jogo da forca

 Data de Início - 14/03/26
 Autor - João Pedro Soares

Descrição: O programa deve escolher uma palavra dentre um conjunto predefinido; O usuário deve tentar encontrar todas as letras ou acertar a palavra toda em um chute.
Para cada letra inserida o programa deve exibir se ela está ou não na palavra. Quando o usuário acertar 1/4 das letras ele terá a opção de chutar a plavra toda,
caso erre ele perde o jogo.
*/
